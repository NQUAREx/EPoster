...
def test_sleep_voice_command_toggles_mode_and_dims_ambilight(isolated_app, monkeypatch):
    ...
    def fake_set_brightness(value: int):
        calls.append(value)

    monkeypatch.setattr(isolated_app._ambilight, "set_brightness", fake_set_brightness)
...
def test_sleep_mode_is_applied_on_startup(tmp_path, monkeypatch):
    ...
    def fake_set_brightness(self, value: int):
        calls.append(value)

    monkeypatch.setattr("hardware.ambilight.AmbilightController.set_brightness", fake_set_brightness)
