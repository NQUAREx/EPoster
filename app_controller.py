...
class AppController:
    ...
    def _apply_sleep_ambilight_brightness(self) -> None:
        target_brightness = self._SLEEP_AMBILIGHT_BRIGHTNESS if self.settings.sleep_mode else self.settings.ambilight_brightness
        self._ambilight.set_brightness(target_brightness)
